# Step 1. Extract TEST_ keys from .env
$testKeys = Get-Content .env | ForEach-Object {
...
# Step 3. Scan project for each TEST_ key
...
$result | Export-Csv -Path "test_keys_usage.csv" -NoTypeInformation -Encoding UTF8
Write-Host "✅ Done. Results saved to test_keys_usage.csv"
